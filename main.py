...
parser.add_argument('--data_aug', type=int, default=1, help='data augmention or not(default: 1)')
...
parser.add_argument('--cuda', type=int, default=0, help='disable CUDA training')
...
if __name__=="__main__":
    train(data_aug=args.data_aug_bool, rand_num=args.rand_num, batch_size=args.batch_size, epochs=args.epochs, lr=args.lr, momentum=args.momentum, log_interval=args.log_interval, cuda=args.cuda, path="models/trained_model.model")
